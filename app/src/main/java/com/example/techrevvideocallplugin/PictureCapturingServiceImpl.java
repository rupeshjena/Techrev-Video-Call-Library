...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    public void startCapturing(final PictureCapturingListener listener) {
        ...
        try {
            ...
            Log.e(TAG , "Camera ID found in your phone: "+frontCameraId);
            if (frontCameraId != -1) {
                this.cameraIds.add(String.valueOf(frontCameraId));
                //this.currentCameraId = this.cameraIds.poll();
                this.currentCameraId = String.valueOf(frontCameraId);
                openCamera();
            } else {
                //No camera detected!
    ...
    private void openCamera() {
        ...
        try {
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.CAMERA)
                    ...
                    == PackageManager.PERMISSION_GRANTED) {
                manager.openCamera(String.valueOf(frontCameraId), stateCallback, null);
            }
    ...
    private final ImageReader.OnImageAvailableListener onImageAvailableListener = (ImageReader imReader) -> {
        ...
        buffer.get(bytes);
        Log.e(TAG , "Captured image bytes data: "+bytes);
    ...
    private void takePicture() throws CameraAccessException {
        ...
        // Added by Rupesh to handle App Crash
